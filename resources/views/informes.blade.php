                    ...
                    <table class="table text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if($informe->id_comentario == null && $informe->id_publicacion == null)
                                <td>
                                <p>-------</p>
                                </td>
                                @else
                                                @if($informe->id_comentario == null)
                                                    ...
                                                    <i class="fa-solid fa-magnifying-glass" style="color: #FF0DDC;"></i></button>
                                                                        ...
                                                                        <div class="d-flex align-items-center mb-1">
                                                                            ...
                                                                            <div class="row align-items-center">
                                                                                <div class="col-md-2 text-center">
                                                                                    <p class="card-text">
                                                                                        <p>
                                                                                            <button type="submit">{{ $informe->publicacion->likes->count() }} <i class="fa-regular fa-heart" style="color: #FF0DDC;"></i></button>
                                                                                        </p>
                                                                                    </p>
                                                                                </div>
                                                                                ...
                                                                                <div class="col-md-2 text-start">
                                                                                    <p class="card-text">
                                                                                        <button><i class="fa-regular fa-comment" style="color: #FF0DDC;"></i> {{ $informe->publicacion->comentarios->count() }} </button> 
                                                                                    </p>
                                                                                </div>
                                                                            </div>
                                                                    </div>
                                ...
                                @if($informe->solucion==null)
                                    ...
                                    <td>
                                                    <form id="editarU{{ $informe->id_reporte }}" action="{{ route('editarInformeUser', ['id_informe' => $informe->id_reporte]) }}" method="POST">
                                                            @csrf
                                                            <button type="button" data-bs-toggle="modal" data-bs-target="#editarInformeUser{{ $informe->id_reporte }}">
                                                            <i class="fa-solid fa-pencil" style="color: #FF0DDC;"></i></button>


                                                            <div class="modal fade" id="editarInformeUser{{ $informe->id_reporte }}" tabindex="-1" aria-labelledby="editarInformeUser{{ $informe->id_reporte }}" aria-hidden="true">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        <div class=" modal-body emergente textoB">
                                                                                Selecciona una solución para el informe:
                                                                        </div>
                                                                        <div class="modal-body text-start ">
